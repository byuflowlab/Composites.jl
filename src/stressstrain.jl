...
"""
    plystrain(tply::Array{<:Real,1},nply::Array{<:Integer,1},theta::Array{<:Real,1},
...
"""
function getplystrain(nply::Array{<:Integer,1},tply::Array{<:Real,1},theta::Array{<:Real,1},
...
"""
function getplystress(plystrain::Array{<:Real,2},q::Array{<:Real,3},matid::Array{<:Integer,1})
